...
class ApcStorage extends AbstractStorage {
    ...
    public function stats() {
        ...
        return [
            static::HITS => isset($stats['num_hits']) ? $stats['num_hits'] : 0,
            static::MISSES => isset($stats['num_misses']) ? $stats['num_misses'] : 0,
            static::UPTIME => isset($stats['start_time']) ? $stats['start_time'] : 0,
            static::MEMORY_USAGE => isset($stats['mem_size']) ? $stats['mem_size'] : 0,
            static::MEMORY_AVAILABLE => isset($info['avail_mem']) ? $info['avail_mem'] : 0
        ];
    }

...
class WincacheStorage extends AbstractStorage {
    ...
    public function stats() {
        ...
        return [
            static::HITS => $stats['total_hit_count'],
            static::MISSES => $stats['total_miss_count'],
            static::UPTIME => $stats['total_cache_uptime'],
            static::MEMORY_USAGE => $memory['memory_total'],
            static::MEMORY_AVAILABLE => $memory['memory_free']
        ];
    }

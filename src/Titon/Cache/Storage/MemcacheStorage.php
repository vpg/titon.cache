...
class MemcacheStorage extends AbstractStorage {
    ...
    public function stats() {
        ...
        return [
            static::HITS => $stats['get_hits'],
            static::MISSES => $stats['get_misses'],
            static::UPTIME => $stats['uptime'],
            static::MEMORY_USAGE => $stats['bytes'],
            static::MEMORY_AVAILABLE => $stats['limit_maxbytes']
        ];
    }
